...
import 'package:bike_buddy/screens/bikes/screens/documents/insurance/edit_insurance_screen.dart';
...
class InsuranceScreen extends StatefulWidget {
  ...
  InsuranceScreen({super.key, required this.documents, required this.function});
...
class _InsuranceScreenState extends State<InsuranceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          Theme(
            ...
            child: Visibility(
              visible: widget.documents != null &&
                  widget.documents?.insurance != null,
      ...
      body: widget.documents == null || widget.documents?.insurance == null
          ? AddInsuranceScreen(
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat('dd/M/yyyy').format(
                                      widget.documents!.insurance!.expiration),
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            color: myBackgroundColor,
                            child: Visibility(
                              visible: widget.documents!.insurance!.expiration
                                      .compareTo(DateTime.now()) >
                                  0,
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    calculateDateDifference(
                                        DateTime.now(),
                                        widget
                                            .documents!.insurance!.expiration),
                                    style: myTextStyle.copyWith(fontSize: 20),
                                  ),
                                ],
                              ),
  ...
  void getImagesWidget() {
    ...
    if (widget.documents != null && widget.documents?.insurance != null) {
      for (var image in widget.documents!.insurance!.images) {
  ...
  void refresh(Documents document) {
    setState(() {
