...
class EditCivScreen extends StatefulWidget {
  ...
  @override
  State<EditCivScreen> createState() => _EditCivScreenState();
}

class _EditCivScreenState extends State<EditCivScreen> {
          ...
          child: Column(
            children: [
              ...
              FormBuilderImagePicker(
                ...
                initialValue: widget.documents?.civ?.images,
              ...
              Theme(
                ...
                child: FormBuilderDateTimePicker(
                    ...
                    initialValue: widget.documents?.civ?.expiration,
  ...
  DateTime? extractExpirationDate(String text) {
    ...
    final Iterable<Match> matches = datePattern.allMatches(text);
