...
import 'package:bike_buddy/screens/bikes/screens/documents/civ/edit_civ_screen.dart';
...
class CivScreen extends StatefulWidget {
  ...
  CivScreen({super.key, required this.documents, required this.function});
...
class _CivScreenState extends State<CivScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          Theme(
            ...
            child: Visibility(
              visible:
                  widget.documents != null && widget.documents?.civ != null,
      ...
      body: widget.documents == null || widget.documents?.civ == null
          ? AddCivScreen(
                              ...
                              children: [
                                ...
                                Text(
                                  DateFormat('dd/M/yyyy').format(
                                      widget.documents!.civ!.expiration),
                      ...
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            color: myBackgroundColor,
                            child: Visibility(
                              visible: widget.documents!.civ!.expiration
                                      .compareTo(DateTime.now()) >
                                  0,
                              child: Column(
                                children: [
  ...
  void getImagesWidget() {
    ...
    if (widget.documents != null && widget.documents?.civ != null) {
      for (var image in widget.documents!.civ!.images) {
